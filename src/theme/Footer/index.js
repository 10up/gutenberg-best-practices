      ...
      <div className="footer-about">
        <div className="footer-about-inner">
          ...
          <div className="cta-careers">
            ...
            <a href="https://10up.com/careers" className="button">Careers at 10up</a>
